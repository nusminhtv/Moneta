...
| --- | --- |
| First run shows it; later runs do not | `test/features/onboarding/onboarding_controller_test.dart` |
...
| Splash hands over unaided | `test/features/onboarding/splash_test.dart` with a fake clock |
