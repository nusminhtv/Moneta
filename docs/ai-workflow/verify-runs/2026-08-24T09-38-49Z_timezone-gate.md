# Verify run — timezone-gate

- **When (UTC):** 2026-08-24T09:39:11Z
- **Mode:** full
- **Commit:** cff067b
- **Result:** ❌ FAIL
...
| format | FAIL | Changed test/design_system/molecules/transaction_row_test.dart Formatted 82 files (1 changed) in 0.13 seconds.  |
