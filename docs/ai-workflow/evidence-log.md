...
| 2026-09-09 | checkpoint | 4.2 first-run: a primary action that works, and steps that tick independently | `19b6525` | `verify-runs/2026-09-09T07-53-28Z_home-overview.md` |
